...
export async function POST(req: Request) {
  ...
  // The coach reply is AI-generated in Greece's voice from the thread history
  // (interim: the real Greece takes over once the admin panel ships). If Groq
  // is unavailable, fall back to the canned acknowledgement so the thread is
  // never left hanging.
