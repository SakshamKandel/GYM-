...
const STEPS: { n: string; word: string; tail: string; body: string; glyph: ReactNode }[] = [
  ...
  },
  {
    ...
    word: 'Keep going',
    tail: '',
    body: 'The hard part. Streaks, PR moments, and a real coach in your corner when you need one. Consistency beats intensity, and the app is built to protect it.',
    glyph: (
      <path
