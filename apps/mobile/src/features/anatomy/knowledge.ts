...
export const MUSCLE_KNOWLEDGE: Record<MuscleGroup, MuscleKnowledge> = {
  chest: {
    ...
    training: {
      ...
      mistakes: [
        ...
        'Letting the shoulders roll forward. Keep the shoulder blades pinched and down.',
      ],
    },
  },
  lats: {
    ...
    originInsertion:
      'The largest back muscle. It spans from your lower spine and pelvis up into the front of the upper arm.',
    functions: [
  ...
  'lower back': {
    ...
    training: {
      ...
      frequency: '1–2× per week. Recovery is slow, so leave 48h+ before heavy hinging again',
      tips: [
  ...
  shoulders: {
    ...
    originInsertion:
      'Caps the shoulder, running from collarbone and shoulder blade down to the outside of the upper arm.',
    functions: [
  ...
  traps: {
    ...
    training: {
      ...
      mistakes: [
        'Rolling the shoulders during shrugs. It adds nothing and irritates the joint.',
  ...
  biceps: {
    ...
    training: {
      ...
      mistakes: [
        ...
        'Only curling heavy: the biceps respond well to strict 12 to 15 rep sets.',
      ],
    },
  },
  triceps: {
    ...
    originInsertion:
      'Three heads, one from the shoulder blade and two from the arm bone, merging into the elbow tip.',
    functions: [
    ...
    training: {
      ...
      tips: [
        'The long head only fully stretches with the arm overhead, so overhead extensions are non-negotiable for size.',
      ...
      mistakes: [
        'Only doing pushdowns. They barely train the long head, which is two-thirds of the muscle.',
  ...
  quadriceps: {
    ...
    training: {
      ...
      tips: [
        ...
        'Leg extensions are the only lift that fully shortens the rectus femoris, so keep them.',
      ],
      mistakes: [
        'Cutting depth as the weight goes up.',
        'Letting the hips shoot back first ("good-morning squat"). It shifts the work to glutes and back.',
      ],
    },
  },
  hamstrings: {
    ...
    training: {
      ...
      tips: [
        ...
        'Seated leg curls train the hamstrings at longer length than lying curls, so they are slightly better for growth.',
  ...
  abductors: {
    ...
    training: {
      ...
      mistakes: [
        ...
        'Letting the hips wobble on lunges. That IS the abductors failing, so slow down.',
      ],
    },
  },
  neck: {
