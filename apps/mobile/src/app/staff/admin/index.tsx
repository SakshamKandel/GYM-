...
const NAV_ROWS: NavRow[] = [
  ...
  },
  {
    icon: 'bar-chart',
    title: 'Analytics',
    blurb: 'Revenue, promos, coaches, tier + country breakdowns.',
    route: STAFF_ROUTES.adminAnalytics,
    perm: 'analytics.read',
  },
  {
    icon: 'megaphone',
    title: 'Broadcast',
    blurb: 'Send a push announcement + review send history.',
    route: STAFF_ROUTES.adminBroadcast,
    perm: 'broadcast.send',
  },
  {
    icon: 'trophy',
    title: 'Gamification',
    blurb: 'XP corrections, badge revoke, challenge moderation.',
    route: STAFF_ROUTES.adminGamification,
    perm: 'gamification.manage',
  },
  {
    icon: 'library',
    title: 'Catalog',
    blurb: 'Author the exercise + training-plan library.',
    route: STAFF_ROUTES.adminCatalog,
    perm: 'catalog.manage',
  },
  {
    icon: 'flag',
    title: 'Moderation',
    blurb: 'Review member milestones and progress photos.',
    route: STAFF_ROUTES.adminModeration,
    perm: 'moderation.manage',
  },
  {
    icon: 'storefront',
    title: 'Partners',
    blurb: 'Meal-partner (restaurant) roster and access.',
    route: STAFF_ROUTES.adminPartners,
  ...
  },
  {
    icon: 'alert-circle',
    title: 'Abuse',
    blurb: 'Referral + trial abuse signals; reset a trial.',
    route: STAFF_ROUTES.adminAbuse,
    perm: 'subscription.override',
  },
  {
    icon: 'key',
    title: 'Permissions',
    blurb: 'Per-account permission grants and denials.',
    route: STAFF_ROUTES.adminPermissions,
    perm: 'permissions.override',
  },
  {
